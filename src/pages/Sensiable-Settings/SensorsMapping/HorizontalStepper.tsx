...
const HorizontalStepper = () => {
  ...
  return (
    <div className='mb-5 '>
      ...
      <h5 style={{ fontWeight: 'normal' }}> Individual Sensors Mapping</h5>
      <Row>
        <Col>
              ...
              <div className="horizontal-steps mt-4 mb-4 px-10">
                <div className="horizontal-steps-content">
                  ...
                  <div className="step-item current"  style={horizontalLineStyles.blueDot}>
                    ...
                    >
                      <span onClick={handleItemClick}>Verify & Configure <br></br>sensors</span>
                    </OverlayTrigger>
                  </div>
                </div>
                <div className="process-line" style={{ ...horizontalLineStyles.blueLine, width: '100%' }}></div>
              </div>
            </Col>
          </Row>
        </Col>
