...
const HorizontalStepper = () => {
  ...
  const handleOrderPlacedClick = () => {
    navigate('/pages/mappingsettings');
  };

  return (
    <div className='mb-5 '>
      <h3 className="page-title">Commisioning</h3>
      <h5 style={{ fontWeight: 'normal' }}> Upload Layout</h5>
      <Row>
        <Col>
            ...
            <Col lg={7} md={10} sm={11}>
              <div className="horizontal-steps mt-4 mb-4 px-10">
                <div className="horizontal-steps-content">
                  ...
                  <div className="step-item" style={horizontalLineStyles.blueDot}>
                    <span  onClick={handleOrderPlacedClick}>Seat Mapping &<br></br>Meeting Room Mapping</span>
                  </div>
                ...
                <div className="process-line" style={{ ...horizontalLineStyles.blueLine, width: '38%' }}></div>
              </div>
            </Col>
          </Row>
        </Col>
