...
const HorizontalStepper = () => {
  ...
  const handleOrderPlacedClick = () => {
    navigate('/pages/sensormapping');
  };

  return (
    <div className='mb-5 '>
      <h3 className="page-title">Commisioning</h3>
      <h5 style={{ fontWeight: 'normal' }}> Commissioning Individual Sensors</h5>
      <Row>
        <Col>
            ...
            <Col lg={7} md={10} sm={11}>
              <div className="horizontal-steps mt-4 mb-4 px-10">
                <div className="horizontal-steps-content">
                  ...
                  <div className="step-item" style={horizontalLineStyles.blueDot}>
                  <span >Download Site<br></br> commissioning sequence file</span>
                  </div>
                  ...
                  <div className="step-item current"  style={horizontalLineStyles.blueDot}>
                    ...
                    >
                      <span onClick={handleOrderPlacedClick}>Verify & Configure <br></br>sensors</span>
                    </OverlayTrigger>
                  </div>
                </div>
                <div className="process-line" style={{ ...horizontalLineStyles.blueLine, width: '81%' }}></div>
              </div>
            </Col>
          </Row>
        </Col>
