...
const projects: Project[] = [
    ...
    {
        id: 3,
        title: 'Sensiable v2.1 - Angular and Django',
        state: 'Ongoing',
    ...
    {
        id: 4,
        title: 'Sensiable v2.1 - React, Webpack',
        state: 'Finished',
    ...
    {
        id: 5,
        title: 'Sensiable 2.2 - Vue.Js and Laravel',
        state: 'Ongoing',
        image: projectImg1,
        totalTasks: 3,
        totalComments: 104,
    ...
    {
        id: 6,
        title: 'Sensiable 2.3 - Rails, NodeJs, Mean',
        state: 'Planned',
        image: projectImg2,
        totalTasks: 11,
        totalComments: 201,
    ...
    {
        id: 7,
        title: 'Sensiable - Landing page and UI Kit',
        state: 'Planned',
        image: projectImg3,
        totalTasks: 3,
        totalComments: 104,
