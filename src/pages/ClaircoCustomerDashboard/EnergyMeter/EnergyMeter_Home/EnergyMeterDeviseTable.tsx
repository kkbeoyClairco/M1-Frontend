...
const EnergyMeterTable = ({ setTotalDevices }: any) => {
    ...
    const handleNavigation = (data: any) => {
        ...
        // console.log('energy table data', searchParam.toString());

        let url = `/customer/energymeter/${searchParam.toString()}`;
    ...
    const getEnergyMeterList = async () => {
        try {
            setIsLoading(true);
        ...
        <Row style={{ paddingRight: '0px' }}>
            ...
            <Card>
                <Card.Body>
                    <Row>
                        <Col>
                            <h4 className="header-title mb-3">Energy Meter Device List</h4>
                        </Col>
                    </Row>
                    {!devicesExists && (
                        <Row>
                            <Col>
                                <h4 className="header-title mb-3">No Energy Meter devices installed here</h4>
                            </Col>
                        </Row>
                    )}
                    {!isLoading ? (
