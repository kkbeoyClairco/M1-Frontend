...
const TrendsChart = ({
    ...
    const getLiveDataAPI = useCallback(async () => {
        try {
            ...
            // console.log('Data from api:', tableData1);
            ...
            setCardData({
                fanSpeed: tableData1?.[tableData1.length - 1]?.['Fan Speed'] ?? '',
                mode: tableData1?.[tableData1.length - 1]?.['Mode'] ?? '',
                zoneTemp: tableDataSetTemp[tableDataSetTemp.length - 1],
                setTemp: tableDataSetTemp[tableDataSetTemp.length - 1],
                lastUpdated: time?.[time.length - 1] ?? '',
                status: tableData1?.[tableData1.length - 1]?.['Status'],
            });
