...
type WashroomParameterModalProps = {
    show: boolean;
    onClose: () => void;
  ...
  const WashroomParameterModal: React.FC<WashroomParameterModalProps> = (props: WashroomParameterModalProps) => {
...
export default WashroomParameterModal;
