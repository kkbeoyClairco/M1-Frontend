...
import { resetAuth, claircoCustomerLogin } from 'redux/actions';
...
export default function useClaircoCustomerLogin() {
    ...
    const onSubmit = (formData: UserLoginData) => {
        dispatch(claircoCustomerLogin(formData['email'], formData['password']));
        // console.log('bhanu')
    };
