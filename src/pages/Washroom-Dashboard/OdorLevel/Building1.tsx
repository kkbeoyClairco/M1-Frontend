...
const Building1 = () => {
    const [washrooms, setWashrooms] = useState([
        { id: 1, ppm: Math.floor(Math.random() * 100), indicatorValue: Math.floor(Math.random() * 101) },
        { id: 2, ppm: Math.floor(Math.random() * 100), indicatorValue: Math.floor(Math.random() * 101) },
        { id: 3, ppm: Math.floor(Math.random() * 100), indicatorValue: Math.floor(Math.random() * 101) },
        { id: 4, ppm: Math.floor(Math.random() * 100), indicatorValue: Math.floor(Math.random() * 101) },
    ]);
