...
const Building1 = () => {
    const [washrooms, setWashrooms] = useState([
        { id: 1,  indicatorValue: Math.floor(Math.random() * 101) },
        { id: 2, indicatorValue: Math.floor(Math.random() * 101) },
        { id: 3,  indicatorValue: Math.floor(Math.random() * 101) },
        { id: 4,  indicatorValue: Math.floor(Math.random() * 101) },
    ]);
