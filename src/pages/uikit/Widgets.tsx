                    ...
                    <Timeline>
                        <TimelineItem>
                            ...
                            <div className="timeline-item-info">
                                ...
                                <small>Paul Burgess just purchased “Sensiable - Admin Dashboard”!</small>
...
const Widgets = () => {
    ...
    const transactionData: Transcation[] = [
        {
            icon: 'mdi mdi-arrow-collapse-up',
            title: 'Purchased Sensiable Admin Template',
            time: 'Today',
            amount: '-$489.30',
