...
const graphOptions: { [key: string]: string } = {
    a: 'live',
    //  b: 'aggregated'
};
...
const TrendsChart = ({ sensorNameVOC, sensorNameNH3, deviceId, buildingId }: any) => {
    ...
    const getGraphData = (graphState: any) => {
        try {
            ...
            if (graphState === parameters.a) return data.VOC;
            else if (graphState === parameters.b) return data.NH3;
                    ...
                    <Row>
                        <Tab.Container defaultActiveKey="live">
                            ...
                            <Row className="d-flex">
                                <Col className="" sm={12} lg={3} style={{ alignItems: 'flex-start' }}>
                                ...
                                <Col md={9} className="trends-chart-container">
                                    {!isLoading ? (
                                        <ReactEcharts
                                            option={option}
                                            style={{ height: '60vh', width: '100%', overflow: 'clip' }}
                                        />
                                    ) : (
